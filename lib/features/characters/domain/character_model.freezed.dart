    ...
    return _then(_value.copyWith(
      ...
      origin: null == origin
          ...
          : origin // ignore: cast_nullable_to_non_nullable
              as String,
      episodesNumber: null == episodesNumber
...
class _$_CharacterModel implements _CharacterModel {
  ...
  @override
  String toString() {
    return 'CharacterModel(id: $id, name: $name, state: $state, urlImage: $urlImage, gender: $gender, species: $species, location: $location, origin: $origin, episodesNumber: $episodesNumber)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, name, state, urlImage,
      gender, species, location, origin, episodesNumber);
...
abstract class _CharacterModel implements CharacterModel {
  const factory _CharacterModel(
      ...
      required final int episodesNumber}) = _$_CharacterModel;
